      ...
      <div className="w-full mx-auto pt-8 sm:pt-12 relative">
        <div className="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          <div className="space-y-6 text-center lg:text-left">
            ...
            {/* QUOTE BOX */}
            <div 
              className="relative mt-6 mb-6 rounded-2xl p-[2px] 
                        bg-gradient-to-r from-[#6366f1]/70 via-[#a855f7]/70 to-[#6366f1]/70 
                        shadow-[0_0_25px_rgba(99,102,241,0.5)]"
              data-aos="fade-up"
              data-aos-duration="900"
            >
              <div className="bg-[#0a0a1a]/95 rounded-2xl px-8 py-5 
                              flex items-center justify-center gap-2 
                              backdrop-blur-md">
                <span className="text-base sm:text-lg italic font-medium text-gray-200 text-center">
            ...
            <div className="flex flex-col lg:flex-row items-center gap-4 w-full">
              <a href="/AbhishekGiriResume.pdf" download className="w-full lg:w-auto">
