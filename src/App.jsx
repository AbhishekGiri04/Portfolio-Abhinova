...
import Portfolio from "./Pages/Portofolio"; // Check actual file name
...
const Footer = ({ owner = "Abhishek Giri" }) => {
  ...
  return (
    <footer className="text-center">
      ...
      <span className="block text-sm pb-4 text-gray-500 dark:text-gray-400">
        © {currentYear}{" "}
        <a href="https://www.AbhishekGiri.com/" className="hover:underline">
          {owner}
        </a>
        . All Rights Reserved.
      </span>
